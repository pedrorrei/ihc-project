...
<div class="container" style="margin-top: 20px;">
  <div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
    ...
    <div class="carousel-inner rounded-3">
      <div class="carousel-item active"><a href="csgo.html">
        <div class="d-flex">
          <img src="imagens/carroussel/csgo.png" class="d-block w-100" alt="...">
        </div></a>
      </div>
      <div class="carousel-item"><a href="rocketleague.html">
        <div class="d-flex">
          <img src="imagens/carroussel/rocketleague.jpg" class="d-block  w-100" alt="...">
        </div></a>
      </div>
      <div class="carousel-item"><a href="fifa23.html">
        <div class="d-flex">
...
<div class="video-card-container">  
  <div class="video-card">
    ...
    <a href="steam.html"><img src="imagens/plataforma/steam 2.png" mute loop class="card-video"></img></a>
  </div>
  <div class="video-card">
...
<h1 class="title margem30">Recommended for You</h1>
    <div class="movies-list">
        ...
        <div class="card-container">
            ...
            <div class="card">
              <img src="imagens/jogos/cod.png" class="card-img" alt="">
              <div class="card-body">
...
<div class="movies-list">
    ...
    <button class="nxt-btn"><img src="imagens/random/nxt.png" alt=""></button>
    <div class="card-container">
      <h4 style="color: #FF66C4;"> Wishlist is empty. Add games to see it</h4>
    </div>
</div>
   ...
   <div class="movies-list">
       ...
       <div class="card-container">
           ...
           <div class="card">
             <img src="imagens/jogos/rocket league.jpg" class="card-img" alt="">
             <div class="card-body">
           ...
           <a href="fifa23.html"><div class="card">
