...
<div class="text" style="display: flex;justify-content: center;margin-top: 50px;margin-bottom: 50px;margin-left: 50px;margin-right: 50px">
  <p style="font-size:500%;font-family:Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;">FIFA 23</p>
</div>
...
<div class="container" style="background-color: #1b0a39; border-radius: 5px;"> 
  <div class="containerjogo" style="margin-right: 10%;">
    <div class="image" style="display: flex;justify-content: center;">
      <img src="imagens/jogos/fifa23.jpg" width="80%" class="rounded-corners"style="margin-top: 5%;margin-bottom: 5%;max-width: 400px;"></img>
    </div>
    <div class="text" style="margin-top: 20px;margin-bottom: 20px;">
    <p style="font-size:80%;margin-bottom: 5%;"><i>Powered by Football™, EA SPORTS™ FIFA 23 traz o maior jogo do mundo aos gramados com a tecnologia HyperMotion2, entregando ainda mais realismo nas partidas, a FIFA World Cup™ masculina e feminina, a inclusão de clubes femininos, recursos de crossplay e muito mais.</i></p>
      <div>
      <?php if (isset($_SESSION['username'])): ?>
    <button id="wishlist-button-fifa23" onclick="addToWishlist('<?php echo $_SESSION['username']; ?>', 'fifa23')" class="btn btn-outline-success me-2" type="button"><i class="far fa-heart"></i> Add to Wishlist</button>
<?php else: ?>
    <p>Please <a href="index2.php">log in</a> to add this game to your wishlist.</p> 
    <!-- index2.php foi criado para ir para um login diferente que quando ele da sign in ele vai direto para a pagina do fifa23 sem voltar pra homepage -->
<?php endif; ?>
      </div>
    </div>
  </div>
  ...
  <div class="video-card-container3">  
    <div class="video-card3">
      <div class="video-card-price3">
        ...
        <a href="https://store.steampowered.com/app/1811260/EA_SPORTS_FIFA_23/"><img src="imagens/plataforma/steam 2.png" mute loop class="card-video3"></img>
        <span class="card__footer text">
          <p style="font-size:80%;margin-top: 15px;">29.99€ </p>
        </span></a>
      </div>
    </div>
    <div class="video-card3">
      <img src="imagens/plataforma/psn.png" class="video-card-image3" alt="">
      <a href="https://www.playstation.com/pt-pt/games/ea-sports-fifa-23/"><img src="imagens/plataforma/psn 2.png" mute loop class="card-video3"></img>
      <span class="card__footer text">
        <p style="font-size:80%;margin-top: 15px;">59.99€ </p>
      </span></a>
    </div>
    <div class="video-card3">
      <img src="imagens/plataforma/origin.png" class="video-card-image3" alt="">
      <a href="https://www.ea.com/pt-br/games/fifa/fifa-23/buy/pc"><img src="imagens/plataforma/origin 2.png" mute loop class="card-video3"></img>
      <span class="card__footer text">
    ...
    <div class="video-card3">
      ...
      <a href="https://store.epicgames.com/en-US/p/fifa-23"><img src="imagens/plataforma/epicgames 2.png" mute loop class="card-video3"></img>
      <span class="card__footer text">
        <p style="font-size:80%;margin-top: 15px;">59.99€ </p>
      </span></a>
    </div>
    <div class="video-card3">
      ...
      <a href="https://www.xbox.com/pt-PT/games/fifa-23"><img src="imagens/plataforma/xbox 2.jpg" mute loop class="card-video3"></img>  
      <span class="card__footer text">
        <p style="font-size:80%;margin-top: 15px;">59.99€ </p>
      </span></a>
    </div>
...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    xhr.onreadystatechange = function() {
        if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
            var button = document.getElementById("wishlist-button-fifa23");
            var response = JSON.parse(this.responseText);
            if (response.message === "Game is in the wishlist") {
                button.innerHTML = '<i class="far fa-trash"></i> Remove from Wishlist';
                button.className = 'btn btn-outline-danger me-2';
                button.onclick = function() { removeFromWishlist('<?php echo $_SESSION['username']; ?>', 'fifa23'); };
            } else {
                button.innerHTML = '<i class="far fa-heart"></i> Add to Wishlist';
                button.className = 'btn btn-outline-success me-2';
                button.onclick = function() { addToWishlist('<?php echo $_SESSION['username']; ?>', 'fifa23'); };
            }
        }
    }
    
    xhr.send("username=" + encodeURIComponent('<?php echo $_SESSION['username']; ?>') + "&game=fifa23");
});
